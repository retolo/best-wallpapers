'use client'
import css from './PrivacyModal.module.css'
import ModalWrapper from '../Privacy/ModalWrapper'
...
export default function PrivacyModal({isOpenModal, onClose}: PrivacyModalProps){

    return(
        <ModalWrapper onClose={onClose} isOpen={isOpenModal}>
            <article className={css.privacyPolicy}>
                <header>
                    <div className={css.wrapper}>
                        <h1>Privacy Policy</h1>
                        <svg onClick={onClose} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className={css.closeIcon} viewBox="0 0 16 16">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                        </svg>
                    </div>

                    <p>
                    <strong>Last updated:</strong> 7 July 2026
                    </p>
                </header>

                <section className={css.section} >
                    <p>
                    Akiyo operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the &quot;Services&quot;). Akiyo is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
                    </p>
                    <p>
                ...
                <section className={css.section}>
                    ...
                    <p>
                    The Services are hosted by Shopify, which collects and processes personal information about your access to and use of the Services in order to provide and improve the Services for you. Information you submit to the Services will be transmitted to and shared with Shopify as well as third parties that may be located in countries other than where you reside, in order to provide and improve the Services for you. To learn more about how Shopify uses your personal information and any rights you may have, you can visit the <a href="https://www.shopify.com/legal/privacy/app-users" target="_blank" rel="noopener noreferrer">Shopify Consumer Privacy Policy</a>. Depending on where you live, you may exercise certain rights with respect to your personal information here <a href="https://privacy.shopify.com/en" target="_blank" rel="noopener noreferrer">Shopify Privacy Portal Link</a>.
                    </p>
                </section >
                ...
                <section className={css.section}>
                    <h2>Contact</h2>
                    <address>
                    Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:hello@akiyo.co.uk">hello@akiyo.co.uk</a>.
                    </address>
                </section >
                </article>  
        </ModalWrapper>
